$(document).ready(function () {
    ...
    $.ajax({
                ...
                url: "http://45.77.85.108:8081/admin/statistics/month/"+year,
    ...
    $.ajax({
                type: "GET",//方法类型
                contentType: "application/json",
                url: "http://45.77.85.108:8081/admin/statistics/sort",
                success: function (result) {
     ...
     */
     ...
     $.ajax({
                type: "GET",//方法类型
                contentType: "application/json",
                url: "http://45.77.85.108:8081/admin/statistics/gender",
                success: function (result) {
     ...
     */
     $.ajax({
                type: "GET",//方法类型
                contentType: "application/json",
                url: "http://45.77.85.108:8081/admin/statistics/area",
                success: function (result) {
